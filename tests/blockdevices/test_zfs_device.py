...
from iml_common.test.command_capture_testcase import CommandCaptureCommand, CommandCaptureTestCase
...
class TestZfsDeviceImportExport(TestZfsDevice):
    def setUp(self):
        ...
        mock.patch('iml_common.blockdevices.blockdevice_zfs.LockFile',
    ...
    def test_busy_export(self):
        ...
        mock.patch('iml_common.blockdevices.blockdevice_zfs.time.sleep').start()
...
class TestZfsDeviceLockFile(TestZfsDevice):
    def setUp(self):
        ...
        mock.patch('iml_common.blockdevices.blockdevice_zfs.ZfsDevice.LOCK_ACQUIRE_TIMEOUT',
